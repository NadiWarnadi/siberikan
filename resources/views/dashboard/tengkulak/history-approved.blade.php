...
@section('title', 'History Approved - SIBERIKAN')
...
<div class="container-fluid py-4">
    <div class="header-section">
        <h1><i class="bi bi-check-circle"></i> History Penawaran Disetujui</h1>
        <p>Daftar semua penawaran yang telah disetujui dan masuk ke inventory</p>
    </div>
    ...
    <div class="search-section">
        <div class="search-group">
            <input type="text" id="searchInput" placeholder="Cari Kode Penawaran atau Nelayan...">
    ...
    @if($penawarans->count() > 0)
        <div id="historyContainer">
            @foreach($penawarans as $penawaran)
                <div class="history-card" data-searchtext="{{ $penawaran->kode_penawaran }} {{ $penawaran->nelayan->nama ?? '' }}">
                    ...
                    <div class="card-details">
                        ...
                        <div class="detail-item">
                            <div class="detail-label"><i class="bi bi-calculator"></i> Total</div>
                            <div class="detail-value">Rp {{ number_format($penawaran->jumlah_kg * $penawaran->harga_per_kg, 0, ',', '.') }}</div>
                        </div>
                    </div>

                    <div class="approval-info">
                        <div class="approval-info-icon"><i class="bi bi-check-circle"></i></div>
                        <div class="approval-info-text">
                            Disetujui oleh <strong>{{ $penawaran->approver->nama ?? 'N/A' }}</strong> 
                    ...
                    <div class="card-actions">
                        ...
                        <a href="{{ route('tengkulak.generate-invoice', $penawaran->id) }}" class="btn-small btn-invoice">
    ...
    @else
        <div class="empty-state">
            ...
            <h5>Belum Ada Penawaran yang Disetujui</h5>
            <p class="text-muted">Semua penawaran yang Anda setujui akan muncul di sini</p>
        </div>
    @endif
</div>
